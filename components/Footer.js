...
const Footer = () => {
  ...
  return (
    <main className='py-5 text-gray-200 bg-secondary'>
      <div className='flex flex-col items-center justify-between max-w-4xl px-4 mx-auto xl:max-w-6xl md:flex-row'>
        <p className='order-last mx-0 text-sm text-center w-46 md:text-start md:w-auto md:order-first'>
